...
/**
 * This interface describes a function for subtracting two number (see strategy pattern).
 *
 * @param <T>
 ...
 */
public interface SubtractionOperation<T extends DigitSequence<? extends Digit>> {
