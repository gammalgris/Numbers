...
/**
 * This interface describes a function for negating a number (see strategy pattern).
 *
 * @param <T>
 ...
 */
public interface NegationOperation<T extends DigitSequence<? extends Digit>> {
