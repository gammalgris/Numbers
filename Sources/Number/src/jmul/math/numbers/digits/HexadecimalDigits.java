 ...
 */
public enum HexadecimalDigits implements Digit {
     ...
     */
    private HexadecimalDigits(char aSymbol) {
     ...
     */
    public static HexadecimalDigits charToDigit(char aSymbol) {

        for (HexadecimalDigits digit : values()) {
