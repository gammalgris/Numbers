...
public class NumberGreaterThanOrEqualComparisonTest {
     ...
     *        the expected comparison result
     */
    public NumberGreaterThanOrEqualComparisonTest(int base, String firstOperandString, String secondOperandString,
    ...
    public void testComparison() {
        ...
        try {
            ...
            // check the operation
            boolean actualResult = firstOperand.isGreaterOrEqual(secondOperand);
    ...
    public void testComparisonVariant2() {
        ...
        try {
            ...
            // check the operation
            boolean actualResult = Math.isGreaterOrEqual(firstOperand, secondOperand);
