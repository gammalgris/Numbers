...
public class LesserComparisonTest {
     ...
     *        the expected comparison result
     */
    public LesserComparisonTest(int base, String firstOperandString, String secondOperandString,
    ...
    public void testComparison() {
        ...
        try {
            ...
            // check the operation
            boolean actualResult = firstOperand.isLesser(secondOperand);
    ...
    public void testComparisonVariant2() {
        ...
        try {
            ...
            // check the operation
            boolean actualResult = Math.isLesser(firstOperand, secondOperand);
