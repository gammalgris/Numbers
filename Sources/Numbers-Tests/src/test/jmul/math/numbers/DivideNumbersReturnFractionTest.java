...
public class DivideNumbersReturnFractionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { NumberHelper.createInfinity(base), createNumber(base, "1"),
                                          FractionHelper.createInfinity(base) });
            parameters.add(new Object[] { createNumber(base, "1"), NumberHelper.createInfinity(base),
                                          createFraction(base, "1", null) });
            parameters.add(new Object[] { NumberHelper.createInfinity(base), createNumber(base, "-1"),
                                          FractionHelper.createInfinity(base, Signs.NEGATIVE) });
            parameters.add(new Object[] { NumberHelper.createNegativeInfinity(base), createNumber(base, "1"),
                                          FractionHelper.createInfinity(base, Signs.NEGATIVE) });
            parameters.add(new Object[] { createNumber(base, "1"), NumberHelper.createNegativeInfinity(base),
                                          createFraction(base, "-1", null) });
            parameters.add(new Object[] { createNumber(base, "-1"), NumberHelper.createInfinity(base),
                                          createFraction(base, "-1", null) });
            ...
            parameters.add(new Object[] { createNumber(base, "0"), createNumber(base, "1"),
                                          createFraction(base, "0", "1") });
            parameters.add(new Object[] { createNumber(base, "0"), createNumber(base, "1"),
