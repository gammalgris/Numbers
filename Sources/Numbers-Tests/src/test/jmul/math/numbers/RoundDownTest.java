...
/**
 * This test suit tests rounding down numbers.
 *
...
public class RoundDownTest {
     ...
     *        the expected result
     */
    public RoundDownTest(Number number, Number expectedResult) {
    ...
    /**
     * Rounds down a number and checks the result.
     */
    @Test
    public void testRoundingDown() {

        Number actualResult = number.roundDown();
     ...
     */
    @Test
    public void testRoundingDownVariant2() {

        Number actualResult = Math.roundDown(number);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createNumber(Signs.NEGATIVE, base), createNumber(Signs.NEGATIVE, base) });
        ...
        parameters.add(new Object[] { createNumber(2, "1.0001"), createNumber(2, "1") });
