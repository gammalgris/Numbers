...
public class NumberLesserThanOrequalFractionComparisonTest {
    ...
    public NumberLesserThanOrequalFractionComparisonTest(Number number, Fraction fraction, boolean expectedResult) {
    ...
    public void testComparison() {
        ...
        boolean actualResult = number.isLesserOrEqual(fraction);
    ...
    public void testComparisonVariant2() {
        ...
        boolean actualResult = Math.isLesserOrEqual(number, fraction);
