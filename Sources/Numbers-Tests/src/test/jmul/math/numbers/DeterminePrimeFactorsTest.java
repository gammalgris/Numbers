...
public class DeterminePrimeFactorsTest {
     ...
     */
    public DeterminePrimeFactorsTest(Number number, Number... divisors) {
    ...
    public void checkDivisors() {
        ...
        SortedSet<Number> actualResult = number.primeFactors();
    ...
    public void checkDivisorsVariant2() {
        ...
        SortedSet<Number> actualResult = Math.primeFactors(number);
    ...
    public static Collection<Object[]> data() {
        ...
        // 8 : { 2 }
        parameters.add(new Object[] { createNumber(2, "1000"), new Number[] { createNumber(2, "10") } });
        // 9 : { 3 }
        ...
        // 8 : { 2 }
        parameters.add(new Object[] { createNumber(3, "22"), new Number[] { createNumber(3, "2") } });
        // 9 : { 3 }
        ...
        // 8 : { 2 }
        parameters.add(new Object[] { createNumber(4, "20"), new Number[] { createNumber(4, "2") } });
        // 9 : { 3 }
        ...
        // 100 : { 2, 5 }
        parameters.add(new Object[] { createNumber(10, "100"),
                                      new Number[] { createNumber(10, "2"), createNumber(10, "5") } });
        ...
        // 2139 : { 3, 23, 31 }
        parameters.add(new Object[] { createNumber(10, "2139"),
                                      new Number[] { createNumber(10, "3"), createNumber(10, "23"),
                                                     createNumber(10, "31") } });
