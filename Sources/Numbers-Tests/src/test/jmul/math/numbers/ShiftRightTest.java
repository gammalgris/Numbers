...
public class ShiftRightTest {
     ...
     */
    public ShiftRightTest(int base, String operandString, String resultString) {
    ...
    public String toString() {
        ...
        String summary = String.format("[base:%d] shift right %s", base, operandString);
        return summary;
    }

    /**
     * Tests shifting a decimal point to the right.
     */
    @Test
    public void testShiftRight() {
        ...
        try {
            ...
            // check the operation
            Number actualResult = operand.shiftRight();

            String message = String.format("shift right %s => %s", operandString, resultString);
    ...
    public void testShiftRightVariant2() {
        ...
        try {
            ...
            // check the operation
            Number actualResult = Math.shiftRight(operand);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { base, "1", "10" });
            parameters.add(new Object[] { base, "-1", "-10" });

            parameters.add(new Object[] { base, "1.1", "11" });
            parameters.add(new Object[] { base, "-1.1", "-11" });

            parameters.add(new Object[] { base, "11.1", "111" });
            parameters.add(new Object[] { base, "-11.1", "-111" });

            parameters.add(new Object[] { base, "1.1010101", "11.010101" });
            parameters.add(new Object[] { base, "-1.1010101", "-11.010101" });
        }

        for (int base = BASE_MIN_LIMIT + 1; base <= BASE_MAX_LIMIT; base++) {

            parameters.add(new Object[] { base, "2", "20" });
            parameters.add(new Object[] { base, "-2", "-20" });

            parameters.add(new Object[] { base, "0.2", "2" });

            parameters.add(new Object[] { base, "2.1212", "21.212" });
            parameters.add(new Object[] { base, "-2.1212", "-21.212" });
        }
