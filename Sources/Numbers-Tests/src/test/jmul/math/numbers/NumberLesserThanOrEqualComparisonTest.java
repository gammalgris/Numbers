...
public class NumberLesserThanOrEqualComparisonTest {
     ...
     *        the expected comparison result
     */
    public NumberLesserThanOrEqualComparisonTest(int base, String firstOperandString, String secondOperandString,
    ...
    public void testComparison() {
        ...
        try {
            ...
            // check the operation
            boolean actualResult = firstOperand.isLesserOrEqual(secondOperand);
    ...
    public void testComparisonVariant2() {
        ...
        try {
            ...
            // check the operation
            boolean actualResult = Math.isLesserOrEqual(firstOperand, secondOperand);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { base, "0", "0", true });
            parameters.add(new Object[] { base, "1", "0", false });
            parameters.add(new Object[] { base, "0", "1", true });
