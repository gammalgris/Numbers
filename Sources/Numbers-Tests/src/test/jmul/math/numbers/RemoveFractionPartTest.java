...
/**
 * This test suite tests truncating numbers (i.e. removing the fraction part).
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class RemoveFractionPartTest {
     ...
     */
    public RemoveFractionPartTest(int base, String operandString, String resultString) {
    ...
    public String toString() {
        ...
        return String.format("[base:%d] truncate %s = %s", base, operandString, resultString);
    }
    ...
    public void testTruncatingNumber() {
        ...
        try {
            ...
            // check the operation
            Number actualResult = operand.removeFractionPart();
    ...
    public void testTruncatingNumberVariant2() {
        ...
        try {
            ...
            // check the operation
            Number actualResult = Math.removeFractionPart(operand);
