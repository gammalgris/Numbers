...
/**
 * This test suite tests if numbers can be identified as even.
 *
...
public class EvenNumberTest {
     ...
     *        the expected result
     */
    public EvenNumberTest(int base, String operandString, boolean expectedResult) {
    ...
    public void testEven() {
        ...
        boolean actualResult = operand.isEven();
     ...
     */
    @Test
    public void testEvenVariant2() {

        boolean actualResult = Math.isEven(operand);
        assertEquals(toString(), expectedResult, actualResult);
    }
