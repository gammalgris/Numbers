...
public class MaxNumberFractionTest {
     ...
     *        the expected result
     */
    public MaxNumberFractionTest(Number operand1, Fraction operand2, Fraction expectedResult) {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createNumber(base, "0"), createFraction(base), createFraction(base) });
            parameters.add(new Object[] { createNegativeInfinity(base), createFraction(base), createFraction(base) });
            parameters.add(new Object[] { createNumber(base, "0"), createFraction(Signs.NEGATIVE, base),
                                          createFraction(base, "0") });
            parameters.add(new Object[] { createInfinity(base), createFraction(Signs.NEGATIVE, base),
                                          createFraction(base) });
