...
public class MaxNumberFractionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createNumber(base, "0"), FractionHelper.createInfinity(base),
                                          FractionHelper.createInfinity(base) });
            parameters.add(new Object[] { NumberHelper.createNegativeInfinity(base),
                                          FractionHelper.createInfinity(base), FractionHelper.createInfinity(base) });
            parameters.add(new Object[] { createNumber(base, "0"), FractionHelper.createInfinity(base, Signs.NEGATIVE),
