...
/**
 * This test suite tests comparing two numbers and getting the lesser number.
 *
...
public class MinNumberTest {
    ...
    /**
     * Tests comparing two numbers and getting the lesser number.
     */
    @Test
    public void testGettingMin() {

        Number actualResult = firstOperand.min(secondOperand);
        assertEquals(expectedResult, actualResult);
    }

    /**
     * Tests comparing two numbers and getting the bigger the number.
     */
    @Test
    public void testGettingMaxVariant2() {

        Number actualResult = Math.min(firstOperand, secondOperand);
        assertEquals(expectedResult, actualResult);
    }
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { base, "" + digit.symbol(), "0", "0" });
            parameters.add(new Object[] { base, "0", "" + digit.symbol(), "0" });
        }
