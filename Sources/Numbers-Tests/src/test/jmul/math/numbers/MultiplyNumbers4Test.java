...
public class MultiplyNumbers4Test {
    ...
    public void testMultiplaction() {
        ...
        try {
            ...
            Number actualProduct =
                firstOperand.multiply(OperationIdentifiers.LONG_MULTIPLICATION_FUNCTION, secondOperand);
    ...
    public void testMultiplicationVariant2() {
        ...
        try {
            ...
            // check the operation
            Number actualProduct =
                Math.multiply(OperationIdentifiers.LONG_MULTIPLICATION_FUNCTION, firstOperand, secondOperand);
