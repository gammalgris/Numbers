...
/**
 * This test suite tests multiplying a fraction and a number with various combinations of operands.
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class MultiplyFractionAndNumberTest {
     ...
     *        a fraction
     */
    public MultiplyFractionAndNumberTest(Fraction operand1, Number operand2, Fraction expectedResult) {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base, "10", "11"), createNumber(base, "1"),
                                          createFraction(base, "10", "11") });
            parameters.add(new Object[] { createFraction(base, "10", "11"), createNumber(base, "-1"),
                                          createFraction(base, "-10", "11") });

            parameters.add(new Object[] { createFraction(base, "1", "10", "11"), createNumber(base, "1"),
