...
public class CreateFractionWithInvalidParameters2Test {
     ...
     *        the expected exception type
     */
    public CreateFractionWithInvalidParameters2Test(int base, String numeratorString, String denominatorString,
    ...
    public void testCreation() {
        ...
        try {
            ...
            createFraction(base, numeratorString, denominatorString);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = Constants.BASE_MIN_LIMIT; base <= Constants.BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { base, "-0", "-0", IllegalArgumentException.class });
        }
