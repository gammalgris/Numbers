...
/**
 * This test suite tests comparing two fractions and getting the lesser fraction.
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class MinFractionTest {
     ...
     *        the expected result
     */
    public MinFractionTest(Fraction operand1, Fraction operand2, Fraction expectedResult) {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base), createFraction(base, "0"), createFraction(base, "0") });
