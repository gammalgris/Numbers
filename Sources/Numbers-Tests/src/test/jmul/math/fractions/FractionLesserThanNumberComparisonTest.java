...
public class FractionLesserThanNumberComparisonTest {
     ...
     *        the expected comparison result
     */
    public FractionLesserThanNumberComparisonTest(Fraction fraction, Number number, boolean expectedResult) {
    ...
    public void testComparison() {
        ...
        boolean actualResult = fraction.isLesser(number);
    ...
    public void testComparisonVariant2() {
        ...
        boolean actualResult = Math.isLesser(fraction, number);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base, "0"), createNumber(base, "0.1"), true });
