...
public class MaxFractionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base), createFraction(base, "0"), createFraction(base) });
            parameters.add(new Object[] { createFraction(base), createFraction(Signs.NEGATIVE, base),
                                          createFraction(base) });
            parameters.add(new Object[] { createFraction(Signs.NEGATIVE, base), createFraction(base, "0"),
