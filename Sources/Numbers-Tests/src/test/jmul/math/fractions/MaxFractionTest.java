...
/**
 * This test suite tests comparing two fractions and getting the greater fraction.
 *
 * @author Kristian Kutin
 */
@UnitTest
@RunWith(Parameterized.class)
public class MaxFractionTest {
     ...
     *        the expected result
     */
    public MaxFractionTest(Fraction operand1, Fraction operand2, Fraction expectedResult) {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { FractionHelper.createInfinity(base), createFraction(base, "0"),
            ...
            parameters.add(new Object[] { FractionHelper.createInfinity(base, Signs.NEGATIVE),
                                          createFraction(base, "0"), createFraction(base, "0") });
            parameters.add(new Object[] { FractionHelper.createInfinity(base, Signs.NEGATIVE),
