...
public class FractionGreaterThanOrEqualComparisonTest {
     ...
     *        the expected comparison result
     */
    public FractionGreaterThanOrEqualComparisonTest(Fraction fraction1, Fraction fraction2, boolean expectedResult) {
    ...
    public void testComparison() {
        ...
        boolean actualResult = fraction1.isGreaterOrEqual(fraction2);
    ...
    public void testComparisonVariant2() {
        ...
        boolean actualResult = Math.isGreaterOrEqual(fraction1, fraction2);
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { createFraction(2, "11", "10"), createFraction(2, "1", "1", "10"), true });

        parameters.add(new Object[] { createFraction(10, "11", "10"), createFraction(10, "1", "1", "10"), true });
