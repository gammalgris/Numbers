...
public class HalvingFractionTest {
     ...
     *        the expected result
     */
    public HalvingFractionTest(Fraction fraction, Fraction expectedResult) {
    ...
    public String toString() {
        ...
        return String.format("halve (%d) %s -> (%d) %s", fraction.base(), fraction, expectedResult.base(),
                             expectedResult);
    }

    /**
     * Tests halving a fraction.
     */
    @Test
    public void testHalving() {

        Fraction actualResult = fraction.halving();
    ...
    public void testHalvingVariant2() {
        ...
        Fraction actualResult = Math.halving(fraction);
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { createFraction(2, "1", "1", "1"), createFraction(2, "1", "1") });
        parameters.add(new Object[] { createFraction(2, "-1", "1", "1"), createFraction(2, "-1", "1") });

        parameters.add(new Object[] { createFraction(3, "1", "1", "1"), createFraction(3, "1", "1") });
        parameters.add(new Object[] { createFraction(3, "-1", "1", "1"), createFraction(3, "-1", "1") });
        ...
        parameters.add(new Object[] { createFraction(4, "1", "1", "1"), createFraction(4, "1", "1") });
        parameters.add(new Object[] { createFraction(4, "-1", "1", "1"), createFraction(4, "-1", "1") });

        for (int base = BASE_MIN_LIMIT + 3; base <= BASE_MAX_LIMIT; base++) {

            parameters.add(new Object[] { createFraction(base, "1", "1", "1"), createFraction(base, "1", "1") });
            parameters.add(new Object[] { createFraction(base, "-1", "1", "1"), createFraction(base, "-1", "1") });
        }
