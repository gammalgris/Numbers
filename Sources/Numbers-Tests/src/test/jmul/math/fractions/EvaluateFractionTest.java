...
public class EvaluateFractionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base), createNumber(base) });
            parameters.add(new Object[] { createFraction(Signs.NEGATIVE, base), createNumber(Signs.NEGATIVE, base) });
