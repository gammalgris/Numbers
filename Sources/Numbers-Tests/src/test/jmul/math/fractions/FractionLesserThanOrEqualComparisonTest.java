...
public class FractionLesserThanOrEqualComparisonTest {
     ...
     *        the expected comparison result
     */
    public FractionLesserThanOrEqualComparisonTest(Fraction fraction1, Fraction fraction2, boolean expectedResult) {
    ...
    public void testComparison() {
        ...
        boolean actualResult = fraction1.isLesserOrEqual(fraction2);
    ...
    public void testComparisonVariant2() {
        ...
        boolean actualResult = Math.isLesserOrEqual(fraction1, fraction2);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base, "1", "1"), createFraction(base, "1"), true });
