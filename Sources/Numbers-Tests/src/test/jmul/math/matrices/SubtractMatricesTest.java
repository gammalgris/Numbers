...
/**
 * This test suite tests subtracting matrices.
 *
...
public class SubtractMatricesTest {
     ...
     */
    public SubtractMatricesTest(Matrix matrix1, Matrix matrix2, Matrix expectedResult) {
    ...
    public void addMatrices() {
        ...
        Matrix actualResult = matrix1.subtract(matrix2);
    ...
    public void addMatricesVariant2() {
        ...
        Matrix actualResult = Math.subtract(matrix1, matrix2);
