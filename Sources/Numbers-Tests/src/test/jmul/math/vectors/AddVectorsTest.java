...
/**
 * This test suite tests adding two vectors.
 *
...
public class AddVectorsTest {
     ...
     *        the expected result
     */
    public AddVectorsTest(Vector vector1, Vector vector2, Vector expectedResult) {
    ...
    public void testAdd() {
        ...
        Vector actualResult = vector1.add(vector2);
     ...
     */
    @Test
    public void testAddVariant2() {

        Vector actualResult = Math.add(vector1, vector2);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createVector(base, "1"), createVector(base, "-1"), createVector(base, "0") });
