 ...
 */
public class SquareRootFunction implements TernaryOperation<Number, Result<Number>> {
    ...
    /**
     * Calculates the next vale for x (i.e. f(x<sub>n+1</sub>) = 1/2 * ( x<sub>n</sub> + s * 1/x<sub>n</sub> ).
     *
     * @param x
