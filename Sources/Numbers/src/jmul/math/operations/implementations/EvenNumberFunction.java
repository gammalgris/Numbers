...
/**
 * This function implementation tests if a number is even.
 *
 * @author Kristian Kutin
 */
public class EvenNumberFunction implements UnaryOperation<Number, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public EvenNumberFunction() {

        super();
    }

    /**
     * Tests if the specified number is even.
     *
     * @param operand
     *        a number
     *
     * @return <code>true</code> if the specified number is even, else <code>false</code>
     */
    @Override
