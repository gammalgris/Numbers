 ...
 * (see <a href="https://en.wikipedia.org/wiki/Rounding">Rounding to even</a>).
 *
 * @author Kristian Kutin
 */
public class RoundNumberToEvenFunction implements BinaryOperation<Number, Result<Number>> {

    /**
     * The default constructor.
     */
    public RoundNumberToEvenFunction() {
    ...
    public Result<Number> calculate(Number number, Number decimalPlaces) {
        ...
        BinaryOperation<Digit, ResultWithCarry<Digit>> roundDigit =
            (BinaryOperation<Digit, ResultWithCarry<Digit>>) OperationSingletons.getFunction(OperationIdentifiers.ROUND_DIGIT_TO_EVEN_FUNCTION);
