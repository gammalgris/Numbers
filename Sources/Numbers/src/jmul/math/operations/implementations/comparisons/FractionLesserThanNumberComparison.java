 ...
 */
public class FractionLesserThanNumberComparison implements MixedBinaryOperation<Fraction, Number, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public FractionLesserThanNumberComparison() {
