 ...
 */
public class NumberLesserThanOrEqualFractionComparison implements MixedBinaryOperation<Number, Fraction, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public NumberLesserThanOrEqualFractionComparison() {
