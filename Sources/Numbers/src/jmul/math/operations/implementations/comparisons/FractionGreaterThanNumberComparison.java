 ...
 */
public class FractionGreaterThanNumberComparison implements MixedBinaryOperation<Fraction, Number, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public FractionGreaterThanNumberComparison() {
