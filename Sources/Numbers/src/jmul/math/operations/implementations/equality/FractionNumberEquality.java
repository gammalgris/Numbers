 ...
 */
public class FractionNumberEquality implements Operation, MixedEqualityFunction<Fraction, Number> {

    /**
     * The default constructor.
     */
    public FractionNumberEquality() {
     ...
     */
    @Override
    public boolean equals(Fraction t1, Number t2) {
        ...
        Result<Fraction> wrappedResult = conversionFunction.calculate(t2);
        ...
        boolean result = equalityFunction.equals(t1, f1);
