...
/**
 * An implementation of an equality comparator for fractions.
 *
 * @author Kristian Kutin
 */
public class FractionEquality implements Operation, EqualityFunction<Fraction> {
    ...
    /**
     * Compares the two specified fractions regarding equality.
     *
     * @param e1
     *        a number
     * @param e2
