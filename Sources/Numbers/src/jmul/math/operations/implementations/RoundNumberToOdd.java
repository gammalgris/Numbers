 ...
 */
public class RoundNumberToOdd implements BinaryOperation<Number, Result<Number>> {

    /**
     * The default constructor.
     */
    public RoundNumberToOdd() {
    ...
    public Result<Number> calculate(Number number, Number decimalPlaces) {
        ...
        BinaryOperation<Digit, ResultWithCarry<Digit>> roundDigit =
            (BinaryOperation<Digit, ResultWithCarry<Digit>>) OperationSingletons.getFunction(OperationIdentifiers.ROUND_DIGIT_TO_ODD_FUNCTION);
