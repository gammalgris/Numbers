...
/**
 * A simple implementation for a function/ operation/ algorithm repository.
 *
...
public class OperationRepositoryImpl implements OperationRepository {
     ...
     */
    private Map<OperationIdentifier, Class> identifierClassMap;

    /**
     * This map contains all known identifiers and associated instantiated functions.
     */
    private Map<OperationIdentifier, Operation> identifierFunctionMap;
     ...
     */
    private static void checkIdentifier(OperationIdentifier identifier) {
     ...
     */
    @Override
    public void registerFunction(OperationIdentifier identifier, Class implementationClass) {
        ...
        if (identifierClassMap.containsKey(identifier)) {
            ...
            throw new OperationExistsException(identifier.toString());
        }
     ...
     */
    @Override
    public void removeFunction(OperationIdentifier identifier) {
        ...
        if (!identifierClassMap.containsKey(identifier)) {
            ...
            throw new OperationDoesntExistException(message);
        }
     ...
     */
    @Override
    public Operation getFunction(OperationIdentifier identifier) {

        checkIdentifier(identifier);

        if (!identifierClassMap.containsKey(identifier)) {

            throw new OperationDoesntExistException(identifier);
        }
        ...
        try {
            ...
            function = (Operation) clazz.newInstance();
