...
/**
 * This interface describes a polynomial function f(x) = c<sub>n</sub> * x<sup>n</sup> + c<sub>n-1</sub> * x<sup>n-1</sup> + ... + c<sub>1</sub> * x + c<sub>0</sub>.
 *
