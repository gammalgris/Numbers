...
/**
 * A helper class for utility functions regarding function identifiers.
 *
 * @author Kristian Kutin
 */
public final class FunctionIdentifierHelper {

    /**
     * The default constructor.
     */
    private FunctionIdentifierHelper() {
     ...
     */
    private static boolean containsAlgorithm(FunctionIdentifier[] allowedAlgorithms, FunctionIdentifier algorithm) {
        ...
        for (int index = 0; index < allowedAlgorithms.length; index++) {
            ...
            FunctionIdentifier actualAlgorithm = allowedAlgorithms[index];
     ...
     *        an algorithm
     */
    public static void checkAlgorithm(FunctionIdentifier[] allowedAlgorithms, FunctionIdentifier algorithm) {
