...
public enum FunctionIdentifiers implements FunctionIdentifier {
    ...
    VECTOR_EQUALITY_FUNCTION(NONE),
    MATRIX_EQUALITY_FUNCTION(NONE),
    ...
    ADD_VECTORS_FUNCTION(ADDITION),
    SUBTRACT_VECTORS_FUNCTION(SUBTRACTION),
    MULTIPLY_VECTOR_WITH_NUMBER_FUNCTION(MULTIPLICATION),
    SCALAR_PRODUCT_FUNCTION(NONE),
    CROSS_PRODUCT_FUNCTION(NONE),
    TRIPLE_PRODUCT_FUNCTION(NONE),
    ...
    RUSSIAN_DIVISION_FUNCTION(DIVISION),
    ...
    EVALUATE_FRACTION_FUNCTION(DIVISION),
    IS_MULTIPLE_FUNCTION(DIVISION),

    SQUARE_NUMBER_FUNCTION(MULTIPLICATION),
    SQUARE_FRACTION_FUNCTION(MULTIPLICATION),

    DETERMINE_DIVISORS_FUNCTION(NONE),
    DETERMINE_PRIME_FACTORS_NUMBER(NONE),
    DETERMINE_COMMON_DIVISORS_FUNCTION(NONE),
    DETERMINE_COMMON_PRIME_FACTORS_FUNCTION(NONE),
    IS_PRIME_FUNCTION(NONE),
    REDUCE_FRACTION_FUNCTION(NONE),

    ADD_MATRICES_FUNCTION(ADDITION),
    SUBTRACT_MATRICES_FUNCTION(SUBTRACTION),
    ...
    MATRIX_MULTIPLCIATION_FUNCTION(NONE),

    DIGIT_SUM_FUNCTION(NONE),
    DIGIT_TO_NUMBER_FUNCTION(NONE),
    IS_SINGLE_DIGIT_FUNCTION(NONE);
