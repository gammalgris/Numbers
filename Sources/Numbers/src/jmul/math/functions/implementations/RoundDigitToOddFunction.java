...
/**
 * A function for rounding digits (see <a href="https://en.wikipedia.org/wiki/Rounding">rounding to odd</a>).
 *
 * @author Kristian Kutin
 */
public class RoundDigitToOddFunction implements BinaryOperation<Digit, ResultWithCarry<Digit>> {

    /**
     * The default constructor.
     */
    public RoundDigitToOddFunction() {
