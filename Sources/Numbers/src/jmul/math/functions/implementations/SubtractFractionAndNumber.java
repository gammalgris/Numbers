...
/**
 * This class implements a function for subtracting a fraction and a number.
 *
 * @author Kristian Kutin
 */
public class SubtractFractionAndNumber implements MixedBinaryOperation<Fraction, Number, Result<Fraction>> {

    /**
     * The default constructor.
     */
    public SubtractFractionAndNumber() {
