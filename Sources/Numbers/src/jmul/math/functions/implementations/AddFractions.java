...
/**
 * An implementation of a function which adds two fractions.
 *
 * @author Kristian Kutin
 */
public class AddFractions implements BinaryOperation<Fraction, Result<Fraction>> {
    ...
    public Result<Fraction> calculate(Fraction operand1, Fraction operand2) {
        ...
        if (normalizedFraction1.denominator().equals(normalizedFraction2.denominator())) {
            ...
            newNumerator = leftNumerator.add(rightNumerator);
