...
/**
 * This function implementation compares two fractions and returns the lesser fraction.
 *
 * @author Kristian Kutin
 */
public class MinFraction implements BinaryOperation<Fraction, Result<Fraction>> {
