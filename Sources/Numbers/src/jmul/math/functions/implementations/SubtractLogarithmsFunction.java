...
import jmul.math.logarithms.LogarithmImpl;
...
/**
 * An implementation of a function that subtracts two logarithm expressions.
 *
 * @author Kristian Kutin
 */
public class SubtractLogarithmsFunction implements BinaryOperation<Logarithm, Result<Logarithm>> {

    /**
     * The default constructor.
     */
    public SubtractLogarithmsFunction() {

        super();
    }

    /**
     * Subtracts the specified logarithm expressions.
     *
    ...
    public Result<Logarithm> calculate(Logarithm logarithmExpression1, Logarithm logarithmExpression2) {
        ...
        Number product = logarithmExpression1.numerus().divide(logarithmExpression2.numerus());

        Logarithm logarithm = new LogarithmImpl(logarithmBase, product);
