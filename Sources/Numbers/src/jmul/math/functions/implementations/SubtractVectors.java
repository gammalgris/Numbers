...
/**
 * This function implementation subtracts two vectors.
 *
 * @author Kristian Kutin
 */
public class SubtractVectors implements BinaryOperation<Vector, Result<Vector>> {
    ...
    public Result<Vector> calculate(Vector vector1, Vector vector2) {
        ...
        while (iterator1.hasNext() && iterator2.hasNext()) {
            ...
            Number result = component1.subtract(component2);
            results.add(result);
        }
