 ...
 */
public class NumberGreaterThanFractionComparison implements MixedBinaryOperation<Number, Fraction, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public NumberGreaterThanFractionComparison() {
