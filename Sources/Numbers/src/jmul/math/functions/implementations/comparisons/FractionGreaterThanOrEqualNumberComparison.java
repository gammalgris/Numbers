 ...
 */
public class FractionGreaterThanOrEqualNumberComparison implements MixedBinaryOperation<Fraction, Number, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public FractionGreaterThanOrEqualNumberComparison() {
