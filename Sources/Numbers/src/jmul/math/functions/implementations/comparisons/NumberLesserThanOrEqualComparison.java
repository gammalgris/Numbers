 ...
 */
public class NumberLesserThanOrEqualComparison implements BinaryOperation<Number, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public NumberLesserThanOrEqualComparison() {

        super();
    }

    /**
     * Checks if the first operand number is lesser than or equal to the second operand.
     *
     * @param operand1
     *        a number
     * @param operand2
     *        a number
     *
     * @return <code>true</code> if the first operand is lesser than or equal to the second operand,
