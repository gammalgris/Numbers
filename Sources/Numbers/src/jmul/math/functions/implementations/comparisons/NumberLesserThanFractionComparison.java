 ...
 */
public class NumberLesserThanFractionComparison implements MixedBinaryOperation<Number, Fraction, Result<Boolean>> {

    /**
     * The default constructor.
     */
    public NumberLesserThanFractionComparison() {
