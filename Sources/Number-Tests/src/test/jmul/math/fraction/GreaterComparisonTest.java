...
public class GreaterComparisonTest {
     ...
     *        the expected comparison result
     */
    public GreaterComparisonTest(Fraction fraction1, Fraction fraction2, boolean expectedResult) {
    ...
    public void testComparison() {
        ...
        boolean actualResult = fraction1.isGreater(fraction2);
    ...
    public void testComparisonVariant2() {
        ...
        boolean actualResult = Math.isGreater(fraction1, fraction2);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = BASE_MIN_LIMIT; base <= BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base, "1", "100"), createFraction(base, "1", "10"), false });

            parameters.add(new Object[] { createFraction(base, "10"), createFraction(base, "1"), true });
            parameters.add(new Object[] { createFraction(base, "1"), createFraction(base, "1"), false });
            parameters.add(new Object[] { createFraction(base, "1"), createFraction(base, "10"), false });
            ...
            parameters.add(new Object[] { createFraction(base, "1", "10"), createFraction(base, "1"), false });
            parameters.add(new Object[] { createFraction(base, "1", "1"), createFraction(base, "1"), false });
            parameters.add(new Object[] { createFraction(base, "11", "10"), createFraction(base, "1"), true });

            parameters.add(new Object[] { createFraction(base, "1", "10"), createFraction(base, "1", "1", "10"),
                                          false });
            parameters.add(new Object[] { createFraction(base, "1", "1"), createFraction(base, "1", "1", "10"),
                                          false });
        }

        parameters.add(new Object[] { createFraction(2, "11", "10"), createFraction(2, "1", "1", "10"),
                                      false });

        parameters.add(new Object[] { createFraction(10, "11", "10"), createFraction(10, "1", "1", "10"),
                                      false });
