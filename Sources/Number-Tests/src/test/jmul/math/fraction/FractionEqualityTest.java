...
public class FractionEqualityTest {
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = Constants.BASE_MIN_LIMIT; base <= Constants.BASE_MAX_LIMIT; base++) {
            ...
            parameters.add(new Object[] { createFraction(base, "11", "101"), createFraction(base, "10", "110"), false });
            parameters.add(new Object[] { createFraction(base, "10", "110"), createFraction(base, "11", "101"), false });
        ...
        parameters.add(new Object[] { createFraction(2, "1", "101", "11"),
                                      createFraction(2, "10", "10", "11"), true });

        parameters.add(new Object[] { createFraction(10, "1", "5", "3"),
                                      createFraction(10, "2", "2", "3"), true });
