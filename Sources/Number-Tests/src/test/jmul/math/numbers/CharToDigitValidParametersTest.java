...
/**
 * This test suite tests identifying digits by their symbol.
 *
 * @author Kristian Kutin
 */
@RunWith(Parameterized.class)
public class CharToDigitValidParametersTest {
    ...
    public CharToDigitValidParametersTest(int base, char symbol, Digit expectedDigit) {
    ...
    public void testOrdinalToDigit() {
        ...
        Digit actualDigit = NumeralSystems.charToDigit(base, symbol);
        ...
        assertEquals("The symbols don't match!", expectedDigit.symbol(), actualDigit.symbol());
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[] { 16, 'A', HexadecimalDigits.TEN });
        parameters.add(new Object[] { 16, 'B', HexadecimalDigits.ELEVEN });
        parameters.add(new Object[] { 16, 'C', HexadecimalDigits.TWELVE });
        parameters.add(new Object[] { 16, 'D', HexadecimalDigits.THIRTEEN });
        parameters.add(new Object[] { 16, 'E', HexadecimalDigits.FOURTEEN });
        parameters.add(new Object[] { 16, 'F', HexadecimalDigits.FIFTEEN });
