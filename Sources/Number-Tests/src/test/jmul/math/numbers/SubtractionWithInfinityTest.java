...
public class SubtractionWithInfinityTest {
     ...
     *        the expected exception
     */
    public SubtractionWithInfinityTest(Number firstOperand, Number secondOperand, Number expectedResult,
    ...
    public void testAddition() {
        ...
        try {
            ...
            actualResult = firstOperand.subtract(secondOperand);
    ...
    public static Collection<Object[]> data() {
        ...
        for (int base = 2; base < 65; base++) {
            ...
            parameters.add(new Object[] { createNumber(base, "-1"), createInfinity(base), createNegativeInfinity(base),
                                          NO_EXCEPTION });
            parameters.add(new Object[] { createNumber(base, "1"), createNegativeInfinity(base), createInfinity(base),
                                          NO_EXCEPTION });
            parameters.add(new Object[] { createNumber(base, "-1"), createNegativeInfinity(base), createInfinity(base),
                                          NO_EXCEPTION });

            parameters.add(new Object[] { createInfinity(base), createInfinity(base), NO_RESULT,
                                          UndefinedOperationException.class });
            parameters.add(new Object[] { createNegativeInfinity(base), createNegativeInfinity(base), NO_RESULT,
                                          UndefinedOperationException.class });

            parameters.add(new Object[] { createInfinity(base), createNegativeInfinity(base), createInfinity(base),
                                          NO_EXCEPTION });
